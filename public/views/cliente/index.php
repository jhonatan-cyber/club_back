            ...
            <div class=" container-fluid  d-flex align-items-stretch justify-content-between" id="kt_header_container">
                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 mb-5 mb-lg-0"
                    ...
                    <h1 class="text-dark fw-bold mt-1 mb-1 fs-2">
                        <i class="fa-solid fa-users"></i> Cliente <small class="text-muted fs-6 fw-normal ms-1"></small>
                    </h1>
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                <div class="row align-items-center">
                                    <div class>
                                        ...
                                        <h5 class="h3 mb-0">Lista clientes</h5>
                                    </div>
                                </div>
                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                    <div class="row align-items-center">
                                        <div class="col-md-12 align-items-center text-center">
                                            <a href="<?php echo BASE_URL ?>Cliente/pdf" target="_blank"
...
<script src="<?php echo BASE_URL ?>public/views/cliente/cliente.js"></script>

</html>
<?php include_once 'public/components/cliente/modalCliente.php' ?>