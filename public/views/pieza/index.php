...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed">
    ...
    <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
        <div id="kt_header" class="header " data-kt-sticky="true" data-kt-sticky-name="header"
            ...
            <div class=" container-fluid  d-flex align-items-stretch justify-content-between" id="kt_header_container">
                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 mb-5 mb-lg-0"
                    ...
                    <i class="fa-solid fa-house-user"></i> Habitaciones <small
                    ...
                    <div class="col-xl-8 mb-xl-10 col-sm-12 mb-sm-5">
                        <div class="card shadow-sm">
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                <div class="row align-items-center">
                                    <div class>
                                        ...
                                        <h5 class="h3 mb-0">Lista Habitaciones</h5>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <table id="tbPieza"
                                        class="table table-striped gy-5 gs-7 border rounded w-100  align-middle table-row-dashed fs-6 gy-5 dataTable no-footer">
                                        <thead>
        ...
        <script src="<?php BASE_URL ?>public/views/pieza/pieza.js"></script>
    </div>
</body>

</html>
<?php require_once 'public/components/pieza/modalPieza.php' ?>