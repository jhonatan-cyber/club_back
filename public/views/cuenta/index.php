        ...
        <div id="kt_header" class="header " data-kt-sticky="true" data-kt-sticky-name="header"
            ...
            <div class=" container-fluid  d-flex align-items-stretch justify-content-between" id="kt_header_container">
                <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 mb-5 mb-lg-0"
                    ...
                    <i class="fa-solid fa-coins"></i> Cuenta <small class="text-muted fs-6 fw-normal ms-1"></small>
                    </h1>
...
<script src="<?php echo BASE_URL ?>public/views/cuenta/cuenta.js"></script>

</html>
<?php include_once 'public/components/cuenta/modalDetalleCuenta.php' ?>
<?php include_once 'public/components/cuenta/modalAgregarCuenta.php' ?>
<?php include_once 'public/components/venta/modalBebida.php' ?>