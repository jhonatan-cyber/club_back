<div class="footer py-4 d-flex flex-lg-column " id="kt_footer">
    <div class=" container-fluid  d-flex flex-column flex-md-row flex-stack">
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="#" target="_blank" class="text-muted text-hover-primary fw-semibold me-2 fs-6"> © NuweSoft
                <script>
...
<script src="<?php echo BASE_URL ?>public/assets/js/buttons.bootstrap4.min.js"></script>
