            ...
            <form method="post">
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-7">
                                <small class="text-gray-700 d-block m-1"><b>Codigo</b></small>
                                ...
                                <small class="text-gray-700 d-block m-1"><b>Comision</b></small>
                                <div class="input-group input-group-solid mb-3">
                                    <span class="input-group-text" id="basic-addon1"><i
                            ...
                            <div class="col-5 mt-6">
                                <small class="text-gray-700 d-block text-start m-1"><b>Foto</b></small>
                            ...
                            <small class="text-gray-700 d-block m-1"><b>Descripción</b></small>
                            <div class="input-group input-group-solid mb-3">
