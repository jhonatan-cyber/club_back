                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="row">
                         ...
                         <!--        <small
                                    class="d-flex align-items-center text-gray-600 text-hover-primary me-5 mb-1"><b>Importe</b></small>
                                <div class="d-flex input-group input-group-solid mb-3">
                                    <span class="input-group-text" id="basic-addon1"><i
                                            class="fa-solid fa-money-bill"></i></span>
                                    <input type="number" min="0" step="0.01"
                                        class="form-control form-control-sm form-control-solid" id="total_pagar" disabled />
                                </div> -->
